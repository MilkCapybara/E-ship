      ...
      <el-container>
        <el-aside width="240px" class="sidebar">
          ...
          <el-menu :default-active="$route.path" router class="nav-menu">
            <el-menu-item index="/renter/dashboard" class="menu-item">
              <el-icon class="menu-icon"><DataAnalysis /></el-icon>
              <span class="menu-text">数据统计</span>
              <div class="item-glow"></div>
            </el-menu-item>
            <el-menu-item index="/renter/search" class="menu-item">
              <el-icon class="menu-icon"><Search /></el-icon>
              <span class="menu-text">搜索船舶</span>
              <div class="item-glow"></div>
            </el-menu-item>
            <el-menu-item index="/renter/contracts" class="menu-item">
              <el-icon class="menu-icon"><Document /></el-icon>
              <span class="menu-text">我的合约</span>
              <div class="item-glow"></div>
            </el-menu-item>
            <el-menu-item index="/renter/favorites" class="menu-item">
...
import { Search, Document, Star, DataAnalysis } from '@element-plus/icons-vue'
